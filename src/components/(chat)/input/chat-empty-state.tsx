...
import {
  ...
  emptyStateInputVariants,
  emptyStatePillsContainerVariants,
  emptyStatePillItemVariants,
  tapScalePill,
  hoverLiftPill,
  ...
  return (
    ...
    >
      <div className="my-auto flex flex-col items-center justify-center w-full py-spacing-md max-w-3xl">
        {/* Header Stack */}
        <div className="flex flex-col items-center text-center max-w-xl mb-spacing-lg">
          {/* Brand Mark with ambient aura halo */}
          <motion.div
            variants={emptyStateIconVariants}
            className="relative flex items-center justify-center mb-3.5"
          >
            <div className="absolute inset-0 rounded-full bg-theme-brand-primary/10 blur-md pointer-events-none scale-150" />
            <SterlingIcon className="relative size-8 text-theme-brand-primary" />
          </motion.div>
        ...
        {/* Hero Input */}
        <motion.div
          variants={emptyStateInputVariants}
        ...
        <motion.div
          variants={emptyStatePillsContainerVariants}
          className="flex flex-col items-center gap-spacing-xs w-full"
        >
          <motion.div
            variants={emptyStatePillItemVariants}
